module.exports = {
  siteTitle: '株式会社アクシオンテクノロジーズ', // Site title.
  siteTitleAlt: 'Business', // Alternative site title for SEO.
  siteLogo: '/icons/icon-512x512.png', // Logo used for SEO and manifest.
  siteUrl: 'https://agitated-bhaskara-990683.netlify.com', // Domain of your website without pathPrefix.
  ...
  disqusShortname: 'homepage', // Disqus shortname.
